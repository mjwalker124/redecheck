...
public class Contains extends AGEdge {
  ...
  public void populateAlignments() {
    ...
    //			System.out.println("/HTML/BODY/SECTION/DIV     " + child.x1 + "," + child.y1 + "," +
    // child.x2 + "," + child.y2);
    ////			System.out.println(px + " , " + cx);
    //		}
  ...
  private boolean hasSignificantSizeDiff(double p, double c) {
    ...
    return pcSizeDiff < SIZE_DIFF_THRESH && pcSizeDiff > SIZE_DIFF_IGNORE;
  }
  ...
  public String toString() {
    return child.domNode.getxPath() + " contained in " + parent.domNode.getxPath();
  }
