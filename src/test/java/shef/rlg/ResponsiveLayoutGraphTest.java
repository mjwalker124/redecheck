...
public class ResponsiveLayoutGraphTest {
  ...
  //        AlignmentConstraint ac  = new AlignmentConstraint(n1, n2, Type.PARENT_CHILD, 300, 800,
  // new boolean[] {true, false, false, false, true, false});
  ...
  public void testGetAlreadyGathered() {
    ResponsiveLayoutGraph.getAlreadyGathered().add(500);
    assertEquals(ResponsiveLayoutGraph.getAlreadyGathered().size(), 1);
  }
  ...
  public void testSetAlreadyGathered() {
    ...
    newSet.add(300);
    newSet.add(500);
    ResponsiveLayoutGraph.setAlreadyGathered(newSet);
    assertEquals(ResponsiveLayoutGraph.getAlreadyGathered(), newSet);
  }
  ...
  //        assertEquals(Arrays.equals(rlg.getEquationOfLine(set1, set2), new double[]{1, 0,
  // set2[0]}), true);
  //    }
  //
  //    @Test
  ...
  //        assertEquals(Arrays.equals(rlg.getEquationOfLine(set1, set2), new double[]{1, 1, -400}),
  // true);
  //    }
  //
  //    @Test
  ...
  //        assertEquals(Arrays.equals(rlg.getEquationOfLine(set1, set2), new double[]{1, 0.5,
  // -10}), true);
  //    }
  //
  //    @Test
  ...
  //        assertEquals(Arrays.equals(rlg.getBestFitLine(set1, set2, 4), new double[]{1, 0,
  // set2[0]}), true);
  //    }
  //
  //    @Test
  ...
  //        assertEquals(Arrays.equals(rlg.getBestFitLine(set1, set2, 3), new double[]{1, 0,
  // set2[0]}), true);
  //    }
  //
  //    @Test
  ...
  @Test
  public void testUpdateRemainingNodes() {
    Element el = mock(Element.class);
    when(el.getBoundingCoords()).thenReturn(new int[4]);
    when(el.getXpath()).thenReturn("first");
  ...
  public void testUpdateAppearingNode() throws Exception {
    ...
    doReturn(520)
        ...
        .searchForLayoutChange(
            anyString(), anyInt(), anyInt(), anyBoolean(), anyString(), anyBoolean());
  ...
  public void setUpAlignmentCons() {
        ...
        alCons
            .get(
                c.getNode1().getXpath()
                    + " contains "
                    + c.getNode2().getXpath()
                    + LayoutFactory.generateEdgeLabelling(c))
            .generateKey(),
        c.getNode1().getXpath()
            + " contains "
            + c.getNode2().getXpath()
    ...
    String key =
        sibling.getNode1().getXpath()
            + " sibling of "
            + sibling.getNode2().getXpath()
            + sibling.generateAttributeSet();
    assertEquals(
        alCons.get(key).generateKey(),
        sibling.getNode1().getXpath()
            + " sibling of "
            + sibling.getNode2().getXpath()
            + sibling.generateAttributeSet());
  ...
  public void testUpdateRemainingEdges() {
    ...
    AlignmentConstraint ac1 =
        new AlignmentConstraint(
            n1, n2, Type.PARENT_CHILD, 400, 0, c.generateAttributeArray(), null);
    AlignmentConstraint ac2 =
        new AlignmentConstraint(
            n1, n3, Type.PARENT_CHILD, 400, 0, c2.generateAttributeArray(), null);
    AlignmentConstraint ac3 =
        new AlignmentConstraint(
            n2, n3, Type.SIBLING, 400, 0, sibling.generateAttributeArray(), null);
  ...
  ////        assertEquals(map.get(c.getNode1().getXpath() + c.getNode2().getXpath() + " contains "
  // + c.generateEdgeLabelling()), c);
  ////    }
  //
  ////    @Test
  ...
  ////        Node n = new Node("test");
  ////        Node p = new Node("parent");
  ////        AlignmentConstraint ac = new AlignmentConstraint(n, p, Type.PARENT_CHILD, 400, 1000,
  ...
  ////        AlignmentConstraint ac = new AlignmentConstraint(p, n, Type.PARENT_CHILD, 400, 550,
  // new boolean[] {false, false, false, false, false});
  ////        AlignmentConstraint ac2 = new AlignmentConstraint(p2, n, Type.PARENT_CHILD, 551, 720,
  ...
  ////        boolean rightWayRound = Arrays.equals(array, new int[] {400, 500}) &&
  // (Arrays.equals(array2, new int[] {600, 700}));
  ////        boolean flipped = Arrays.equals(array2, new int[] {400, 500}) && (Arrays.equals(array,
  // new int[] {600, 700}));
  ...
  //
  //        rlg.populateWidthArrays(validWidths, widthsTemp, parentWidths, childWidths, "node",
  // "parent");
  //
  ...
  public void testFindAppearPointRecursiveBranch1NodeMatch() throws InterruptedException {
    ...
    Element el1 = new Element("first", 0, 0, 100, 100);
    rlg.url = "randomsite";
    ResponsiveLayoutGraph.alreadyGathered = spy(new HashSet<Integer>());
    doReturn(true).when(ResponsiveLayoutGraph.alreadyGathered).contains(anyInt());
  ...
  //
  //    @Test
  //    public void testFindAppearPointRecursiveBranch2ReturnMaxPlusOne() throws
  ...
  //
  //    @Test
  //    public void testFindDisappearPointRecursiveBranch2ReturnMaxPlusOne() throws
  // InterruptedException {
  //        PowerMockito.mockStatic(Redecheck.class);
  //        rlg.url = "randomsite";
  //        rlg.alreadyGathered = spy(new HashSet<Integer>());
  ...
  ////
  ////    @Test
  ////    public void testFindWidthBreakpointRecursiveBranch2ReturnMinMinusOne() throws
  // InterruptedException {
  ////        PowerMockito.mockStatic(Redecheck.class);
  ////        rlg.url = "randomsite";
  ////        rlg.alreadyGathered = spy(new HashSet<Integer>());
