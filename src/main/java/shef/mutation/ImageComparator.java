...
public class ImageComparator {
  ...
  //    public ImageComparator(String o, String t, int low, int high) throws IOException,
  ...
  //            String oracleFP = outputDir + oracle.replaceAll("/", "") + "/" + "width" + w +
  // "/screenshot.png";
  //            String testFP = outputDir + test.replaceAll("/", "") + "/" + "width" + w +
  // "/screenshot.png";
  ...
  public static void main(String[] args) throws IOException {
    ...
    //        ImageComparator ic = new ImageComparator("demo.com/index", "demo.com/mutant0", 400,
    // 1400);
  ...
  //            Runtime.getRuntime().exec("/usr/local/bin/convert " + screenshot + " -resize
  // 850x850! " + screenshot);
  //        } catch (IOException e) {
  ...
  public int compare(String oracle, String test) {
    ...
    try {
      ...
      //        	Process p = runtime.exec("/usr/local/bin/compare -metric ae oracle.png test.png
      // null:");
      Process p =
          Runtime.getRuntime()
              .exec("/usr/local/bin/compare -metric ae " + oracle + " " + test + " null:");
