...
public class VisibilityErrorTest extends TestCase {
  ...
  @Test
  public void testCalculateRangeOfViewportWidthsBranchOne() {
    oracle = new Node("oracle");
    test = new Node("test");
    VisibilityConstraint vc = new VisibilityConstraint(400, 1200);
    VisibilityConstraint vc2 = new VisibilityConstraint(400, 1100);
  ...
  @Test
  public void testCalculateRangeOfViewportWidthsBranchTwo() {
    oracle = new Node("oracle");
    test = new Node("test");
    VisibilityConstraint vc = new VisibilityConstraint(400, 1200);
  ...
  @Test
  public void testCalculateRangeOfViewportWidthsBranchThree() {
    oracle = new Node("oracle");
    test = new Node("test");
    VisibilityConstraint vc = new VisibilityConstraint(400, 1200);
