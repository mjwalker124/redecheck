...
public class Tool {
  ...
  private static String timesDirectory =
      "/Users/thomaswalsh/Documents/PhD/Code-Projects/Redecheck/times/";
  private static String dataDirectory =
      "/Users/thomaswalsh/Documents/PhD/Papers/main-journal-paper-data/";
  private final String REPORT_DIRECTORY =
      "/Users/thomaswalsh/Documents/PhD/Code-Projects/Redecheck/reports/";
  public String url;
  ...
  public Tool(String[] args) throws IOException {
  ...
  public static void runFaultDetector(
      String current,
      String url,
  ...
  private static void copyMutantInfo() {
    try {
      ...
      File original =
          new File(redecheck + "testing/" + webpage + "/" + mutant + '/' + mutant + ".txt");
  ...
  /**
   * This method samples the DOM of a webpage at a set of viewports, and saves the DOMs into a
   * HashMap
   *
   ...
   * @param domStrings
   */
  public static void capturePageModel(
      String url,
      int[] widths,
      int sleep,
      ...
      HashMap<Integer, String> domStrings) {
  ...
  public static void writeToFile(
      String testUrl, String content, String fileName, String directory) {
  ...
  /**
   * Samples each webpage and constructs an RLG for each, then compares the two, writing the model
  ...
  public void runTool() throws IOException {
    ...
    comp.printDiff();
    comp.writeRLGDiffToFile(
        testUrl, "report-" + sampleTechnique + "-" + stepSize + "-" + binarySearch, true);
    copyMutantInfo();
    ...
    //        writeToFile(testUrl, String.valueOf(duration),
    // "time-"+sampleTechnique+"-"+binarySearch );
    //        writeToFile(testUrl, String.valueOf(testDoms.size()), "doms-"+sampleTechnique+"-" +
    // stepSize + "-" + binarySearch, dataDirectory);
    //        writeToFile(testUrl, String.valueOf(rlg2.getInitialDoms()),
    // "doms-initial-"+sampleTechnique+"-" + stepSize + "-" + binarySearch, dataDirectory);
  ...
  private void processTimes(StopwatchFactory swf, String testUrl) {
    ...
    writeToFile(
        testUrl,
        results,
        "timings-" + sampleTechnique + "-" + stepSize + "-" + binarySearch,
        dataDirectory);
  }
