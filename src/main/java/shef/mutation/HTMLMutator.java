...
public class HTMLMutator {
  ...
  public HTMLMutator(
      String baseURL,
      String shorthand,
      HashMap<String, StyleSheet> stylesheets2,
      ArrayList<Element> classCandidates,
      ArrayList<Element> htmlCandidates,
      Document page,
      HashSet<String> usedClassesHTML,
      HashSet<String> usedIdsHTML,
      HashSet<String> usedTagsHTML,
      int mutantNumber) {
    ...
    while (!managedToMutate) {
      ...
      if (actualElement != null) {
        ...
        if (selector == 6) {
          ...
          writeMutantToFile(
              this.mutantNumber, "Exchanged a class in element \n" + actualElement.toString());
          managedToMutate = true;
          ...
          //                    }
          writeMutantToFile(
              this.mutantNumber, "Changed class in element " + actualElement.toString());
          ...
          writeMutantToFile(
              this.mutantNumber, "Added a class to element \n" + actualElement.toString());
          managedToMutate = true;
        } else if (selector == 5) {
          int indexToRemove = random.nextInt(options.size());
          String classString = "";
          actualElement.removeClass(options.get(indexToRemove));
          writeMutantToFile(
              this.mutantNumber, "Removed a class from element \n" + actualElement.toString());
          managedToMutate = true;
        }
      }
    }
