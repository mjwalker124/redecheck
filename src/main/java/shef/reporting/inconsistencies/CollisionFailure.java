...
/**
 * @author Thomas Walsh
 * @version 2.1 This class extends ResponsiveLayoutFailure and represents element collision failures
 */
public class CollisionFailure extends ResponsiveLayoutFailure {
  ...
  public String toString() {
    return "ELEMENTS "
        + constraint.getNode1().getXpath()
        + " AND "
        + constraint.getNode2().getXpath()
        + " ARE OVERLAPPING BETWEEN "
        + constraint.getMin()
        + " AND "
        + constraint.getMax();
  }
  ...
  public int getWindowWidth() {
    return (constraint.getMin() + constraint.getMax()) / 2;
  }
  ...
  /**
   * Captures a screenshot of the failure, highlights the colliding elements and then saves it to
   * disk
   *
