...
public class ResultClassifier {
  ...
  public ResultClassifier(
      ...
      String oracleUrl,
      String testUrl,
      HashMap<Integer, DomNode> oDoms,
      HashMap<Integer, DomNode> tDoms,
      boolean foundDiffsInRLG) {
  ...
  public static TreeSet<Integer> diffAllDoms(
      HashMap<Integer, DomNode> oracleDoms,
      HashMap<Integer, DomNode> testDoms,
      HashMap<Integer, String> oracleDomsS,
      HashMap<Integer, String> testDomsS,
      int[] widthArray) {
  ...
  public static TreeSet<Integer> diffAllDoms2(
      HashMap<Integer, edu2.gatech.xpert.dom.DomNode> oracleDoms,
      HashMap<Integer, edu2.gatech.xpert.dom.DomNode> testDoms,
      HashMap<Integer, String> oracleDomsS,
      HashMap<Integer, String> testDomsS,
      int[] widthArray) {
  ...
  public static boolean domsEqual2(
      edu2.gatech.xpert.dom.DomNode dn1, edu2.gatech.xpert.dom.DomNode dn2) {
    HashMap<edu2.gatech.xpert.dom.DomNode, edu2.gatech.xpert.dom.DomNode> coordsDiff =
        new HashMap<>();
    ArrayList<edu2.gatech.xpert.dom.DomNode> nonMatching = new ArrayList<>();
    int numMatches = 0;
    edu2.gatech.xpert.dom.DomNode match = null;
    ArrayList<edu2.gatech.xpert.dom.DomNode> worklist1 =
        new ArrayList<edu2.gatech.xpert.dom.DomNode>();
    ArrayList<edu2.gatech.xpert.dom.DomNode> worklist2 =
        new ArrayList<edu2.gatech.xpert.dom.DomNode>();
    worklist1.add(dn1);
    worklist2.add(dn2);
    while (!worklist1.isEmpty()) {
    ...
    //				int[] coords1 = dn.getCoords();
    //				int[] coords2 = pair.getCoords();
    //				System.out.println(dn.getxPath() + "["+coords1[0] + ","+coords1[1] + ","+coords1[2] +
    // ","+coords1[3] + "]  vs  [" +coords2[0] + ","+coords2[1] + ","+coords2[2] + ","+coords2[3] +
    // "]");
    //			}
    //			for (edu2.gatech.xpert.dom.DomNode n : nonMatching) {
    //				System.out.println(n.getxPath() + " was not matched");
    //			}
    return nonMatching.size() == 0;
  }
  ...
  private static boolean hasMeaningfulSize(int[] coords, int[] coords2) {
    ...
    } else return (coords[3] - coords[1]) >= 5;
  }
