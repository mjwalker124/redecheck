...
public class DomUtils {
  ...
  static Map<String, String> ignoredDomData =
  ...
  public static float calculateMatchIndex(DomNode x, DomNode y) {
    ...
    try {
      ...
      float xPathSim =
          1
              - StringUtils.getLevenshteinDistance(xPath1, xPath2)
      ...
      float matchIndex = (XPATH * xPathSim) + (ATTRIB * attrSim) + (DOMDATA * ddSim);
  ...
  private static float getMapSimilarity(Map<String, String> m1, Map<String, String> m2) {
